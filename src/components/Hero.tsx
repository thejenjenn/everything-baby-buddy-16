  ...
  return (
    <section id="home" className="relative bg-background min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-10 w-32 h-32 bg-gradient-to-br from-baby-blue/40 to-powder-blue/30 rounded-full blur-xl animate-float"></div>
        <div className="absolute bottom-32 right-16 w-24 h-24 bg-gradient-to-br from-baby-pink/50 to-blush-pink/40 rounded-full blur-lg animate-float" style={{animationDelay: "1s"}}></div>
        <div className="absolute top-1/3 right-1/4 w-16 h-16 bg-gradient-to-br from-powder-blue/35 to-baby-blue/30 rounded-full blur-md animate-float" style={{animationDelay: "2s"}}></div>
        <div className="absolute top-1/2 left-1/3 w-20 h-20 bg-gradient-to-br from-light-pink/40 to-baby-pink/50 rounded-full blur-lg animate-float" style={{animationDelay: "3s"}}></div>
        <div className="absolute bottom-1/4 left-1/5 w-14 h-14 bg-gradient-to-br from-baby-pink/60 to-light-pink-fill/40 rounded-full blur-md animate-float" style={{animationDelay: "2.5s"}}></div>
        <div className="absolute top-1/4 right-1/3 w-18 h-18 bg-gradient-to-br from-powder-blue/50 to-baby-blue/40 rounded-full blur-lg animate-float" style={{animationDelay: "1.5s"}}></div>
        <div className="absolute top-10 right-10 w-12 h-12 bg-gradient-to-br from-baby-pink/45 to-powder-blue/35 rounded-full blur-sm animate-float" style={{animationDelay: "4s"}}></div>
        <div className="absolute bottom-10 left-1/4 w-28 h-28 bg-gradient-to-br from-baby-blue/30 to-light-pink/35 rounded-full blur-xl animate-float" style={{animationDelay: "0.5s"}}></div>
        <div className="absolute top-3/4 right-1/5 w-22 h-22 bg-gradient-to-br from-blush-pink/35 to-baby-blue/30 rounded-full blur-lg animate-float" style={{animationDelay: "3.5s"}}></div>
      </div>
          ...
          <div className="space-y-10 animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-6 pt-4">
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="text-lg px-10 py-4 font-body font-medium group animate-scale-in border-2 bg-white rounded-full transition-colors duration-300 shadow-lg" 
                style={{
                  animationDelay: "0.8s",
